...
export const AccountsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myApp.accounts.delete.question">
        <Translate contentKey="myApp.accounts.delete.question" interpolate={{ id: accountsEntity.id }}>
