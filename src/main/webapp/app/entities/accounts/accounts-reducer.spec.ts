...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './accounts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTS actions', async () => {
      const expectedActions = [
        {
