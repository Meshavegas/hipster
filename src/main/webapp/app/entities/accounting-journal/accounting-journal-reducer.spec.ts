...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './accounting-journal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTINGJOURNAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOUNTINGJOURNAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTINGJOURNAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTINGJOURNAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTINGJOURNAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTINGJOURNAL actions', async () => {
      const expectedActions = [
        {
